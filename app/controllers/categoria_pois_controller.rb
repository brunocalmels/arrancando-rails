class CategoriaPoisController < ApplicationController
  # before_action :set_categoria_poi, only: [:show, :edit, :update, :destroy]
  ...
  #       format.html { redirect_to @categoria_poi, notice: 'Categoria poi was successfully created.' }
  ...
  #       format.html { redirect_to @categoria_poi, notice: 'Categoria poi was successfully updated.' }
  ...
  #   respond_to do |format|
  #     format.html { redirect_to categoria_pois_url, notice: 'Categoria poi was successfully destroyed.' }
